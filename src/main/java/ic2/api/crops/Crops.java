...
public abstract class Crops {
  ...
  public abstract void registerBaseSeed(
      ItemStack var1, CropCard var2, int var3, int var4, int var5, int var6);

  public abstract BaseSeed getBaseSeed(ItemStack var1);

  public static class CropRegisterEvent extends Ic2Event {
