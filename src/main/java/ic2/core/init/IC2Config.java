...
public class IC2Config {
  ...
  public static class Worldgen {
    public final FabricConfigSpec.BooleanValue rubberTree;
    public final FabricConfigSpec.ConfigValue<String> rubberTreeBlacklist;
    public final FabricConfigSpec.DoubleValue oreDensityFactor;
    public final FabricConfigSpec.DoubleValue treeDensityFactor;
    public final FabricConfigSpec.BooleanValue normalizeHeight;
    public final FabricConfigSpec.IntValue retrogenCheckLimit;
    public final FabricConfigSpec.IntValue retrogenUpdateLimit;

    Worldgen(FabricConfigSpec.Builder b) {
      b.push("worldgen");
      b.comment(
  ...
  public static class Protection {
    public final FabricConfigSpec.BooleanValue wrenchLogging;
    public final FabricConfigSpec.DoubleValue nukeExplosionPowerLimit;
    public final FabricConfigSpec.DoubleValue reactorExplosionPowerLimit;
    public final FabricConfigSpec.BooleanValue enableNuke;

    Protection(FabricConfigSpec.Builder b) {
      b.push("protection");
  ...
  public static class Balance {
    public final FabricConfigSpec.IntValue minerDischargeTier;
    public final FabricConfigSpec.BooleanValue teleporterUseInventoryWeight;
    public final FabricConfigSpec.DoubleValue energyRetainedInStorageBlockDrops;
    public final FabricConfigSpec.IntValue massFabricatorTier;
    public final FabricConfigSpec.IntValue matterFabricatorTier;
    public final FabricConfigSpec.DoubleValue uuEnergyFactor;
    public final FabricConfigSpec.BooleanValue disableEnderChest;
    public final FabricConfigSpec.ConfigValue<String> recyclerBlacklist;
    public final FabricConfigSpec.ConfigValue<String> recyclerWhitelist;
    public final FabricConfigSpec.BooleanValue ignoreWrenchRequirement;
    public final FabricConfigSpec.BooleanValue watermillAutomation;
    public final FabricConfigSpec.DoubleValue euPerChunk;
    ...
    Balance(FabricConfigSpec.Builder b) {
      b.push("balance");
      b.comment(
    ...
    public static class Energy {
      ...
      Energy(FabricConfigSpec.Builder b) {
        b.push("energy");
      ...
      public static class Generator {
        public final FabricConfigSpec.DoubleValue generator;
        public final FabricConfigSpec.DoubleValue geothermal;
        public final FabricConfigSpec.DoubleValue water;
        public final FabricConfigSpec.DoubleValue solar;
        public final FabricConfigSpec.DoubleValue wind;
        public final FabricConfigSpec.DoubleValue nuclear;

        /** Multiplier on base 32 EU/t for each semi-fluid fuel (0 disables registration). */
        public final FabricConfigSpec.DoubleValue semiFluidBiogas;

        public final FabricConfigSpec.DoubleValue semiFluidBiomass;
        public final FabricConfigSpec.DoubleValue semiFluidHydrogen;
        public final FabricConfigSpec.DoubleValue semiFluidCreosote;
        public final FabricConfigSpec.DoubleValue stirling;
        public final FabricConfigSpec.DoubleValue kinetic;
        public final FabricConfigSpec.DoubleValue radioisotope;

        Generator(FabricConfigSpec.Builder b) {
          b.push("generator");
      ...
      public static class HeatGenerator {
        ...
        public final FabricConfigSpec.DoubleValue solid;
        public final FabricConfigSpec.DoubleValue radioisotope;
        public final FabricConfigSpec.DoubleValue electric;

        HeatGenerator(FabricConfigSpec.Builder b) {
      ...
      public static class KineticGenerator {
        public final FabricConfigSpec.DoubleValue water;
        public final FabricConfigSpec.DoubleValue wind;
        public final FabricConfigSpec.DoubleValue manual;
        public final FabricConfigSpec.DoubleValue steam;
        public final FabricConfigSpec.DoubleValue electric;

        KineticGenerator(FabricConfigSpec.Builder b) {
      ...
      public static class FluidConversion {
        public final FabricConfigSpec.DoubleValue heatExchangerLava;
        public final FabricConfigSpec.DoubleValue heatExchangerHotCoolant;
        public final FabricConfigSpec.DoubleValue heatExchangerWater;

        FluidConversion(FabricConfigSpec.Builder b) {
      ...
      public static class FluidReactor {
        public final FabricConfigSpec.DoubleValue outputModifier;

        FluidReactor(FabricConfigSpec.Builder b) {
          b.push("FluidReactor");
    ...
    public static class SteamKineticGenerator {
      public final FabricConfigSpec.IntValue rotorlivetime;

      SteamKineticGenerator(FabricConfigSpec.Builder b) {
    ...
    public static class SteamGenerator {
      ...
      SteamGenerator(FabricConfigSpec.Builder b) {
      ...
      public static class Calcification {
        public final FabricConfigSpec.IntValue maxcalcification;

        Calcification(FabricConfigSpec.Builder b) {
    ...
    public static class SteamRepressurizer {
      public final FabricConfigSpec.IntValue steamPerSteam;
      public final FabricConfigSpec.IntValue steamPerSuperSteam;

      SteamRepressurizer(FabricConfigSpec.Builder b) {
    ...
    public static class Fermenter {
      public final FabricConfigSpec.IntValue needAmountBiomassPerRun;
      public final FabricConfigSpec.IntValue outputAmountBiogasPerRun;
      public final FabricConfigSpec.IntValue hUPerRun;
      public final FabricConfigSpec.IntValue biomassPerFertilizier;

      Fermenter(FabricConfigSpec.Builder b) {
        b.push("fermenter");
    ...
    public static class UuValues {
      public final FabricConfigSpec.ConfigValue<List<? extends String>> predefined;
      public final FabricConfigSpec.ConfigValue<List<? extends String>> worldScan;

      UuValues(FabricConfigSpec.Builder b) {
        b.push("uu-values");
        b.comment(
  ...
  public static class Recipes {
    public final FabricConfigSpec.ConfigValue<String> disable;
    public final FabricConfigSpec.ConfigValue<String> purge;
    public final FabricConfigSpec.ConfigValue<String> jetpackAttachmentBlacklist;
    public final FabricConfigSpec.BooleanValue allowCoinCrafting;
    public final FabricConfigSpec.BooleanValue requireIc2Circuits;
    public final FabricConfigSpec.BooleanValue smeltToIc2Items;
    public final FabricConfigSpec.BooleanValue ignoreInvalidRecipes;

    Recipes(FabricConfigSpec.Builder b) {
      b.push("recipes");
      b.comment(
  ...
  public static class Misc {
    public final FabricConfigSpec.BooleanValue allowBurningScrap;
    public final FabricConfigSpec.ConfigValue<String> additionalValuableOres;
    public final FabricConfigSpec.BooleanValue useLinearTransferModel;
    public final FabricConfigSpec.BooleanValue roundEnetLoss;
    public final FabricConfigSpec.BooleanValue enableEnetExplosions;
    public final FabricConfigSpec.BooleanValue enableEnetCableMeltdown;
  ...
  public static class Debug {
    public final FabricConfigSpec.BooleanValue logEmptyWrenchDrops;
    public final FabricConfigSpec.BooleanValue logIncorrectItemDamaging;
    public final FabricConfigSpec.BooleanValue logGridUpdateIssues;
    public final FabricConfigSpec.BooleanValue logEnetApiAccesses;
    public final FabricConfigSpec.BooleanValue logEnetApiAccessTraces;
    public final FabricConfigSpec.BooleanValue logGridUpdatesVerbose;
    public final FabricConfigSpec.BooleanValue logGridCalculationIssues;

    Debug(FabricConfigSpec.Builder b) {
      b.push("debug");
