...
public class HandHeldOre extends HandHeldUpgradeOption {
  ...
  public static class GuiEditOre extends GuiDefaultBackground<HandHeldOre.ContainerEditOre> {
    public GuiEditOre(
        HandHeldOre.ContainerEditOre container, Inventory playerInventory, Component title) {
    ...
    public class ListItem implements ScrollableList.IListItem {
      ...
      public void draw(
          ...
          int mouseX,
          int mouseY) {
        GuiEditOre.this.drawString(
            guiGraphics, xOffset + 2, yOffset + 1, "Thing " + this.number, 16777215, false);
      }
      ...
      for (byte slot = 0; slot < 9; slot++) {
        this.addSlot(
            new SlotHologramSlot(
                HandHeldOre.this.inventory,
                slot,
                8 + 18 * slot,
                8,
                1,
                HandHeldOre.this.makeSaveCallback()));
      }
    }
