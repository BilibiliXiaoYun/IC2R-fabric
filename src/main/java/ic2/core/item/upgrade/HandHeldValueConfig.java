...
public class HandHeldValueConfig extends HandHeldUpgradeOption {
  ...
  public static class GuiValueConfig
      extends GuiDefaultBackground<HandHeldValueConfig.ContainerValueConfig> {
    public GuiValueConfig(
        HandHeldValueConfig.ContainerValueConfig container,
      ...
      this.addElement(
          new VanillaButton(
                  ...
                  75,
                  15,
                  new EnumCycleHandler<>(ComparisonType.VALUES, container.comparisonType) {
                    @Override
                    public void onClick(MouseButton button) {
                      ...
                      IC2.network
                          .get(false)
                          .sendContainerField(GuiValueConfig.this.menu, "comparisonType");
                    }
                  })
              .withText(
                  (Supplier<String>)
                      () ->
                          Component.translatable(GuiValueConfig.this.menu.comparisonType.name)
                              .getString())
              .withTooltip(
                  new Supplier<>() {
                    ...
                    {
                      this.name =
                          Component.translatable("ic2.upgrade.advancedGUI." + container.base.name)
                              .getString();
                    }

                    public String get() {
                      return Component.translatable(
                              GuiValueConfig.this.menu.comparisonType.name + ".desc", this.name)
                          .getString();
                    }
                  }));
      IEnableHandler rangeEnabled =
          () -> GuiValueConfig.this.menu.comparisonType == ComparisonType.RANGE;
      IEnableHandler filtersEnabled =
          () -> !GuiValueConfig.this.menu.comparisonType.ignoreFilters();
      this.addElement(
          new MoveableButton(
                  this,
                  75,
                  ...
                  17,
                  15,
                  new EnumCycleHandler<>(ComparisonSettings.VALUES, container.normalSetting) {
                    @Override
                    public void onClick(MouseButton button) {
                      super.onClick(button);
                      ...
                      IC2.network
                          .get(false)
                          .sendContainerField(GuiValueConfig.this.menu, "normalSetting");
                      switch (this.getCurrentValue()) {
                        case LESS:
                        case LESS_OR_EQUAL:
                          if (GuiValueConfig.this.menu.extraSetting != ComparisonSettings.LESS
                              && GuiValueConfig.this.menu.extraSetting
                                  != ComparisonSettings.LESS_OR_EQUAL) {
                            GuiValueConfig.this.menu.extraSetting = ComparisonSettings.LESS;
                            IC2.network
                                .get(false)
                                .sendContainerField(GuiValueConfig.this.menu, "extraSetting");
                          }
                          break;
                        case GREATER:
                        ...
                        default:
                          throw new IllegalStateException(
                              "Unexpected other setting: " + this.getCurrentValue());
                      }
                    }
                  })
              .withMoveHandler(rangeEnabled)
              .withEnableHandler(filtersEnabled)
              .withText((Supplier<String>) () -> GuiValueConfig.this.menu.normalSetting.symbol)
              .withTooltip(
                  (Supplier<String>)
                      () ->
                          Component.translatable(GuiValueConfig.this.menu.normalSetting.name)
                              .getString()));
      this.addElement(
          new VanillaButton(
                  this,
                  ...
                  button -> {
                    if (button == MouseButton.left || button == MouseButton.right) {
                      switch (GuiValueConfig.this.menu.normalSetting) {
                        ...
                        default:
                          throw new IllegalStateException(
                              "Unexpected other setting: "
                                  + ((ContainerValueConfig) GuiValueConfig.this.menu)
                                      .normalSetting);
                      }
              ...
              .withText((Supplier<String>) () -> GuiValueConfig.this.menu.extraSetting.symbol)
              .withTooltip(
                  (Supplier<String>)
                      () ->
                          Component.translatable(GuiValueConfig.this.menu.extraSetting.name)
                              .getString()));
      Predicate<String> numberOnly =
          input -> {
            try {
      ...
      final MoveableTextBox textBox =
          new MoveableTextBox(this, 40, 43, 25, 43, 30, 15, this.menu.normalBox);
      this.addElement(
          textBox
              .withMoveHandler(rangeEnabled)
              .withTextWatcher(
                  (oldValue, newValue) -> {
                    ...
                    IC2.network
                        .get(false)
                        .sendContainerField(GuiValueConfig.this.menu, "normalBox");
                  })
              .withTextValidator(numberOnly)
              .withEnableHandler(filtersEnabled));
      this.addElement(
          new TextBox(this, 125, 43, 30, 15, this.menu.extraBox)
              .withTextWatcher(
                  (oldValue, newValue) -> {
      ...
      this.addElement(
          TextLabel.create(
                  ...
                  100,
                  47,
                  TextProvider.ofTranslated("ic2.upgrade.advancedGUI." + container.base.name),
                  4210752,
                  false)
              .withEnableHandler(() -> textBox.isEnabled() && !textBox.isMoved()));
      this.addElement(
          TextLabel.create(
                  this,
                  80,
  ...
  public class ContainerValueConfig extends ContainerHandHeldInventory<HandHeldValueConfig> {
    ...
    @ClientModifiable protected String normalBox = HandHeldValueConfig.this.initialNormalBox;
    @ClientModifiable protected String extraBox = HandHeldValueConfig.this.initialExtraBox;
      ...
      for (byte slot = 0; slot < 9; slot++) {
        this.addSlot(
            new SlotHologramSlot(
                HandHeldValueConfig.this.inventory,
                slot,
                8 + 18 * slot,
                8,
                1,
                HandHeldValueConfig.this.makeSaveCallback()));
      }
    }
