...
public class NetworkManager implements INetworkManager {
  ...
  protected final void sendS2CPacket(
    ...
    // NeoForge exposed this as ServerGamePacketListenerImpl#hasChannel; Fabric tracks the same
    // per-connection channel set behind ServerPlayNetworking#canSend.
    if (handler == null || !ServerPlayNetworking.canSend(player, Ic2Payload.TYPE)) {
      return;
    }
